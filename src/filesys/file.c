...
bool file_can_write(struct file* f) { return f->deny_write; }
bool file_directory(struct file* file) { return inode_directory(file->inode); }
uint32_t get_inumber(struct file* file) { return inode_get_inumber(file->inode); }