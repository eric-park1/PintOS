...
/* Added for proj 3: buffer cache custom tests*/
int get_read_cnt(struct block* block) { return block->read_cnt; }

int get_write_cnt(struct block* block) { return block->write_cnt; }
/* end of addition */